...
RUN wget -qP /opt/sonarqube/extensions/plugins https://github.com/hersonalfaro/ruby-sonar-plugin/releases/download/6.4-rc/sonar-ruby-plugin-hotfix-proposal.jar 
